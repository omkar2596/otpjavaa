//'program 3' ha read karto information 'program 2 'madhun
...
public class Program3 {
	...
	public static void main(String[] args)
	{
		...
		try
		{
			fileInputStream = new FileInputStream ("F:\\New folder\\demo.txt");//'program 2' mdey creat zalela folder data only use karu shkto
...
/*	public static void readUsingDIS() {//readUsingDIS VAPRLEY
  ...
  public static void decryption() {
	  ...
	  try {
		     File objFile = new File("F:\\New folder 3\\ECRYPTED FILE.enc");//'content' read karney key liye
