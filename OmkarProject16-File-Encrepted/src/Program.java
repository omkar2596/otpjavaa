...
//first file save karcvi lagtey manully
import java.io.*;
...
public class Program {
	...
	public static void main(String[] args)    
	{
	     ...
	     try {
	     File objFile = new File("F:\\New folder\\DECRYPTED FILE.txt");//'content' read karney key liye//manualy file save kravi lgnar adhi
	     ...
	     fileOutputStream = new FileOutputStream("F:\\New folder\\ECRYPTED FILE.enc");//data write karney key liye creat kiya hey
